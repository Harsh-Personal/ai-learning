...
input = pn.widgets.TextInput(value="Hi", placeholder="Enter your question here...")
...
dashboard = pn.Column(
    pn.Row("## OrderBot"),
    pn.panel(input, width=600),
    pn.panel(button_conversation, width=100),
    pn.panel(interactive_conversation, width=600),
    pn.panel(panels, width=600),
)
